  ...
  return (
    <section id='home' className='min-h-screen flex py-10 md:flex-row flex-col items-center'>
      <div className='flex-1 flex items-center justify-center h-full'>
        <img src={FHLogo} className='md:w-11/12 h-full object-cover' alt='' />
      </div>
      <div className='flex-1'>
        <div className='md:text-left text-center'>
          ...
          <h3 className='font-[Tussila] text-gray-600 md:2xl text-xl md:leading-normal leading-5 mt-4'>I'm a <span>Frontend Developer</span></h3>
          <button className='btn-contact mt-8' onClick={contact}>Contact Me</button>
